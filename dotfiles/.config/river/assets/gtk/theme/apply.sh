...
theme_assets_path="$HOME/.config/river/assets/gtk/theme"
theme_path="$HOME/.themes/base16"

#check_link() {
#	local file="$1"
#
#	if [ -L "$theme_path/gtk2" ] && [ -L "$theme_path/gtk3" ]; then
#		link_target_gtk2=$(readlink "$theme_path/gtk2")
#		link_target_gtk3=$(readlink "$theme_path/gtk3")
#
#		if [ "$link_target_gtk2" != "$theme_assets_path/gtk2" ] || [ "$link_target_gtk3" != "$theme_assets_path/gtk3" ]; then
#			unlink "$theme_path/gtk2"
#			unlink "$theme_path/gtk3"
#			ln -s "$theme_assets_path/gtk2" "$theme_path/gtk2"
#			ln -s "$theme_assets_path/gtk3" "$theme_path/gtk3"
#		fi
#	else
#		ln -s "$theme_assets_path/gtk2" "$theme_path/gtk2"
#		ln -s "$theme_assets_path/gtk3" "$theme_path/gtk3"
